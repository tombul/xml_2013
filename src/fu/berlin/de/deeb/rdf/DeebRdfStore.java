...
public interface DeebRdfStore {
	 ...
	 * hat verschiedene mit ihr verbundenen Eigenschaften, die jeweils als Tripel im Tripelstore gespeichert
	 * werden. 
	 * @param resource
	 ...
	 * @param params
	 * 				Die Werte der Variablen, mit denen die Platzhalter im Querystring aufgefuellt werden.
	 * @return
